...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'riders/bonus-config', loadComponent: () => import('./features/riders/rider-bonus-config.component').then(m => m.RiderBonusConfigComponent) },
      ...
      { path: 'delivery-fee-config', loadComponent: () => import('./features/platform/delivery-fee-config.component').then(m => m.DeliveryFeeConfigComponent) },
